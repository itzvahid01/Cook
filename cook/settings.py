...
SECRET_KEY = 'django-insecure-ivznj=vb&rkm82=mvs13_yf^o_4_&g$e+)jq$h6l06#6rb(!z4'
...
CORS_ALLOWED_ORIGINS = [
    "http://192.168.70.100:3000",  # آی‌پی یا پورتی که JS روش اجرا میشه
]
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),     # بلندمدت
    'ROTATE_REFRESH_TOKENS': True,                  # هر بار refresh، refresh token جدید بده
